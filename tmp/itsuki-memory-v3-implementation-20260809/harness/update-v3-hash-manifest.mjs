...
const additions = [
	...
	"final/holdout/STAGE-D-CLOSURE.md",
	...
	"final/holdout/harness/probe-stage-e-cohorts.mjs",
	"final/holdout/harness/clean-stage-e-control.mjs",
	"final/holdout/harness/verify-stage-d-closure.mjs",
	"final/holdout/evidence/run.log",
	"final/holdout/evidence/evaluator.log",
	"final/holdout/evidence/run-manifest.json",
	"final/holdout/evidence/stage-e-cohort-preflight-before.json",
	"final/holdout/evidence/stage-e-control-cleanup.json",
	...
	"final/locomo/HARNESS-REPAIR-01.md",
	"final/locomo/INGEST-REPLAY-CONTRACT-PROOF.json",
