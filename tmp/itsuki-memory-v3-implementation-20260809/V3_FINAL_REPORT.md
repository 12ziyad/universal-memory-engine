...
pre-render evidence for 75.65%, semantic rendered evidence for 70.91%, and final
context evidence for 73.77%. There were 83 source-not-stored cases, 226
semantic-capture misses, 332 stored-but-not-retrieved cases, 73 assembly losses,
and 44 questions recovered by source expansion after semantic rendering missed.
This is aggregate evaluation only; reference answers never entered the product
write/read path.

Mean final context was 77.06 items / 14,268 characters / 3,567 approximate
...
The benchmark state contained 5,882 scrubbed episodes, 5,572 atomic candidates,
5,572 projections, 1,296 nodes, 5,514 slices, 824 events and 324 edges before
erasure. Product integrity recorded zero episode, grounding, scope, secret,
...
terminal verdict above supersedes any older “pending”, “not measured”, or
cost-gate language when the two conflict.
